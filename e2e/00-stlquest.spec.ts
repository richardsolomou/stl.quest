...
test('manages a fair print queue and assigns work to printers', async ({ page }) => {
  ...
  await expect(tour.getByRole('heading', { name: 'Your print queue at a glance' })).toBeVisible()
  await screenshot(page, 'product-tour-board')
  await tour.getByRole('button', { name: 'Next' }).click()
  await expect(tour.getByRole('heading', { name: 'Drop files anywhere' })).toBeVisible()
