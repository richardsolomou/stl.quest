...
test('admin setup, upload, viewer, settings, invite, and sign out', async ({ page, browser }) => {
  ...
  await expect(page.getByRole('heading', { name: 'Which printers do you have?' })).toBeVisible()
  await page.getByPlaceholder('Search manufacturer or model…').fill('Ender-3 / Ender-3 v2')
  await page.getByRole('option', { name: /Creality Ender-3 \/ Ender-3 v2/ }).click()
  await expect(page.getByPlaceholder('Search manufacturer or model…')).toHaveValue(/Creality Ender-3 \/ Ender-3 v2/)
  ...
  await page.getByRole('button', { name: 'Add custom printer' }).click()
  ...
  await page.getByRole('button', { name: /Remove Creality Ender-3/ }).click()
