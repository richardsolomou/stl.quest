...
With self-hosting, you control the app, database, files, and history. Hosted deployments can offer 1 GiB of managed storage to one owned workspace per owner account, while other workspaces connect their own remote storage. See the [storage guide](docs/storage.md) for the full policy.
