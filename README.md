...
With self-hosting, you control the app, database, files, and history. Hosted accounts include 5 GB of storage hosted by STL Quest and shared across three owned workspaces, while other workspaces connect their own remote storage. See the [storage guide](docs/storage.md) for the full policy.
