...
> Local SQLite is the default and `/data` should stay on a local filesystem. Set `DATABASE_URL` and `DATABASE_AUTH_TOKEN` to use Turso or another libSQL service instead.
